...
import com.kuaike.manager.KuaiKeActivityManager;
 ...
 * 当前类注释:Activity框架封装类
 */
public class BaseFrameActvity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        KuaiKeActivityManager.getInstance().pushOneActivity(this);
    ...
    public void onBackPressed() {
        ...
        KuaiKeActivityManager.getInstance().popOneActivity(this);
    }
}
